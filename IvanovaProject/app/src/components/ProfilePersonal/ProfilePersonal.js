    ...
    return(
      <div className="profile-row-col profile-personalData profile">
        ...
        <div className="form-group">
          <label htmlFor="profileName">Ваше имя:{this.state.errorInputName ? <img src='../error.png' className="errorImg" alt="error" />: null}</label>
        ...
        <div className="form-group">
          <label htmlFor="profilePhone">Ваш телефон:{this.state.errorInputPhone ? <img src='../error.png' className="errorImg" alt="error" /> : null}</label>
